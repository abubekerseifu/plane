...
export const FilterCycles: React.FC<Props> = (props) => {
  const { appliedFilters, handleUpdate, cycles, searchQuery } = props;
  ...
  const filteredOptions = cycles?.filter((cycle) => cycle.name.toLowerCase().includes(searchQuery.toLowerCase()));
